        ...
        .then((localAudio) => {
          if (localAudio == null) {
            ...
            Repo.findBySlug(syncAudio.repo)
              .then((repo) => {
                ...
                newAudio.save()
                  .then((audio) => {
                    counter++;
                    if (counter == Object.keys(audios).length) {
                      callback();
                    }
                  });
              });
            ...
            if (localAudio.playedTime != undefined) {
              if (syncAudio.playedTime > localAudio.playedTime) {
                console.log('syncAudio.playbackTime:', syncAudio.playbackTime);
              ...
              console.log('localAudio.playbackTime:', localAudio.get('playbackTime'));
              localAudio.set('playbackTime', syncAudio.playbackTime);
              localAudio.save()
                .then((audio) => {
                  counter++
